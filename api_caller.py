...
# ------BELOW IS THE BASIC TEXT2SQL CALL------------
...
#  "Whats the mean value of billed cost for the data"
# #  "Show cost by environment tag." # this query's response returns an error for some reason
#  ]

queries=['What are all the distinct service names']
